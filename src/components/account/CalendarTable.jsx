...
const days = [
	...
	{ date: '2023-12-02', isCurrentMonth: true, events: [] },
	{
		...
		isCurrentMonth: true,
		events: [
			{ id: 1, name: 'Design review', time: '10AM', datetime: '2023-12-03T10:00', href: '#' },
			{ id: 2, name: 'Sales meeting', time: '2PM', datetime: '2023-12-03T14:00', href: '#' },
		],
	},
	...
	{ date: '2023-12-06', isCurrentMonth: true, events: [] },
	{
		date: '2023-12-07',
		isCurrentMonth: true,
		events: [{ id: 3, name: 'Date night', time: '6PM', datetime: '2023-12-08T18:00', href: '#' }],
	},
	...
	{ date: '2023-12-11', isCurrentMonth: true, events: [] },
	{
		...
		isCurrentMonth: true,
		isToday: true,
		events: [{ id: 6, name: "Sam's birthday party", time: '2PM', datetime: '2023-12-25T14:00', href: '#' }],
	},
	...
	{ date: '2023-12-21', isCurrentMonth: true, events: [] },
	{
		...
		isSelected: true,
		events: [
			{ id: 4, name: 'Maple syrup museum', time: '3PM', datetime: '2023-12-22T15:00', href: '#' },
			{ id: 5, name: 'Hockey game', time: '7PM', datetime: '2023-12-22T19:00', href: '#' },
		],
	},
	...
	{ date: '2024-12-01', events: [] },
	{ date: '2024-12-02', events: [] },
	{ date: '2024-12-03', events: [] },
	{
		date: '2024-12-04',
		events: [{ id: 7, name: 'Cinema with friends', time: '9PM', datetime: '2024-01-04T21:00', href: '#' }],
	},
			...
			<header className="flex items-center justify-between border-b border-gray-200 px-6 py-4 lg:flex-none">
				...
				<div className="flex items-center">
					...
					<div className="hidden md:ml-4 md:flex md:items-center">
						...
						<button
							type="button"
							className="ml-6 rounded-md  bg-pink-500 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-pink-300 hover:border-pink-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-600"
						>
							Add event
						</button>
					</div>
